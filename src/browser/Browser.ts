...
class Browser {
    ...
    async createBrowser(proxy: AccountProxy, email: string): Promise<BrowserContext> {
        ...
        // Clear cookies for true incognito behavior
        ...
        this.bot.log(this.bot.isMobile, 'BROWSER', `Created incognito browser with User-Agent: "${fingerprint.fingerprint.navigator.userAgent}"`)
